                ...
                personDetails.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (dataSnapshot.hasChild(phoneNo)) {
                            ...
                            Toast.makeText(SignUp.this, "Already Exisitng", Toast.LENGTH_SHORT).show();
                        } else {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            UserHelperClass helperClass = new UserHelperClass(name, username, phoneNo, password);
                            reference.child(phoneNo).setValue(helperClass);
                            Toast.makeText(SignUp.this, "Data Submitted", Toast.LENGTH_SHORT).show();
    ...
    public void datastore() {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                    ...
                    @Override
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        Toast.makeText(SignUp.this, "Verification Failed: " + e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                    }
                        ...
                        verify.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (verificationCode.isEmpty()) {
                                    Toast.makeText(SignUp.this, "Invalid Entry", Toast.LENGTH_SHORT).show();

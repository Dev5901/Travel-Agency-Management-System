...
public class EditTour extends AppCompatActivity {
    ...
    class Asynchronous extends AsyncTask<String ,Void,List<Tourlistclass>> {
        @Override
        ...
        protected void onPostExecute(List<Tourlistclass> Tourlistclasses) {
            ...
            final TourNamesArrayAdapter cityadapter=new  TourNamesArrayAdapter(EditTour.this , Tourlistclasses);
            listView.setAdapter(cityadapter);
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    Tourlistclass f=(Tourlistclass) cityadapter.getItem(position);
                    Intent in=new Intent(EditTour.this,finaledit.class);
